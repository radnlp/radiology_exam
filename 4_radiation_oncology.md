...
`三次元原体照射`  `強度変調放射線治療`  `高線量率組織内照射`  `定位手術的照射`  `密封小線源永久挿入療法`  
...
- 外部照射
    ...
    - 線量
        ...
        - ちなみに低リスク群に対する寡分割照射も試みられている.
        - ちなみに体幹部定位放射線治療(SBRT)については長期成績がまだ出ておらず, 尿路障害のリスクが高いことが示唆されているため慎重な検討が必要.
    - 有害事象
        - 急性期:
