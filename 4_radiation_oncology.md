...
定位放射線照射の適応に**最もなりにくい**のはどれか。1 つ選べ。
...
m[2013-100](http://www.radiology.jp/content/files/2013_2s_exsam.pdf#page=34)
前立腺癌T2N0M0に対する放射線治療として**適切でない**のはどれか。1つ選べ。  
`三次元原体照射`  `強度変調放射線治療`  `高線量率組織内照射`  `体幹部定位放射線照射`  `密封小線源永久挿入療法`  
