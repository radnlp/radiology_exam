...
**こたえ**
- 2019-97: 
    - `原発と同側別肺葉内の副腫瘍結節`  T4N0M0 = stage IIIA (正解)
    - `胸膜結節かつ同側肺門リンパ節転移`  TxN1M1a = stage IVA
    - `心膜浸潤かつ同側縦隔リンパ節転移`  T3N2M0 = stage IIIB
    - `充実成分径1cmかつ同側鎖骨上窩リンパ節転移`  T1aN3M0 = stage IIIB
    - `肺門まで連続する無気肺かつ気管分岐下リンパ節転移`  T2N2M0 = IIIA (正解)
</details>
