...
- 空腹時の撮像であってもFDGの生理的集積がみられる部位は以下のとおり:
    - 脳: インスリン非依存性のGLUT1の作用による.
    - 唾液腺.
    - 扁桃.
    - 気道粘膜.
    - 褐色脂肪: 特に寒冷刺激により生理的集積が強まる.
    - 甲状腺: 若年女性などにびまん性の生理的集積をみることがある.
...
FDG-PET/CT 検査にて，FDG 投与前に行うと PET 画像に悪影響を及ぼす可能性があるのはどれか。2 つ選べ。
a 会話
b 飲水
c インスリン皮下注
d 生理用食塩水の点滴静注
...
`保険適用は腫瘍診断に限られる。`  
`SUV 値には画像再構成条件が影響する。`  
`18F-FDG の有効半減期は約 6 時間である。`  
`18F-FDG は脱リン酸化されて細胞内に蓄積する。`  
